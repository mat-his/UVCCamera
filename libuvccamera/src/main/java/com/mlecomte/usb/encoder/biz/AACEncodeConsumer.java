package com.mlecomte.usb.encoder.biz;
...
public class AACEncodeConsumer extends Thread{
    ...
    private final int outChannel = 1;
    private final int bitRateForLame = 32;
    ...
    private final boolean isRecMp3 = false;
    private boolean isExit = false;
    private final long prevPresentationTimes = 0;
